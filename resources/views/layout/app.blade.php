...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('admin/node_modules/jquery-bar-rating/dist/themes/css-stars.css') }}">
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo" href="index.html"> <img src="/admin/images/logo.svg"</a>
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle nav-profile" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
              ...
              <span class="d-none d-lg-inline">@guest Daniel Graig @else {{ Auth::user()->fname }}  {{ Auth::user()->lname }} @endguest </span>
            </a>
